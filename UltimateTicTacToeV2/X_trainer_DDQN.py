...
File_Num = 200
path_load= None
path_Save=f'Data/params_{File_Num}copy.pth'
# path_load= f"Data/params_{File_Num}copy.pth"
path_best = f'Data/best_params_{File_Num}copy.pth'
buffer_path = f'Data/buffer_{File_Num}copy.pth'
results_path=f'Data/results_{File_Num}copy.pth'
random_results_path = f'Data/random_results_{File_Num}copy.pth'
path_best_random = f'Data/best_random_params_{File_Num}copy.pth'
...
def main ():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        state_1 = Board()
        end_of_game_2 = False
        action = player2.get_input(events= None, board =state_1)
        state_1 = env.next_Board(board = state_1, action=action)
        while not end_of_game_2:
            ...
            next_actions = player1.get_Actions(next_states, dones, miniboards) #DDQN
            with torch.no_grad():
